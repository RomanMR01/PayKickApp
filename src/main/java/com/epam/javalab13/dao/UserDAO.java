...
public class UserDAO {
	...
	public enum UpdateUserType {
		PASSWORD, BALANCE, ROLE, BAN, LANGUAGE
	}
	...
	public enum GetUsersType {
		ROLE, GENDER, BANN, LANGUAGE, AGE
	}

	public enum GetType {
		ALL, BOSS, ADMIN, BOOKMAKER, CLIENT
	}
	 ...
	 *            the User object
	 * @param type
	 *            the type of User update: PASSWORD, BALANCE, ROLE, BANN or
	 *            LANGUAGE status
	 * @throws SQLException
	 */
	 ...
	 *            the User object
	 * @param type
	 *            the types for getting user :ID, LOGIN, EMAIL
	 ...
	 *
	 * @param type
	 *            the type of get (ALL, BOSS, ADMIN, BOOKMAKER, CLIENT)
	 * @param start
	 *            the start of limit
	 * @param end
	 *            the end of limit
