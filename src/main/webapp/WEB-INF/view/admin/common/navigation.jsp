    ...
    <nav>
        <div class="nav-wrapper grey darken-3">
            ...
            <ul class="side-nav fixed grey darken-4" id="sidebar-nav">
                <li>
                    <a href="" class="center-align logo"><img src="${pageContext.request.contextPath}/static/img/logo.png" alt="PayKick Logo" width="60" height="54"></a>
                </li>
                <li><a href="">VIEW MATCHES<i class="material-icons right red-text text-accent-3">list</i></a></li>
                <li><a href="">VIEW TEAMS<i class="material-icons right orange-text">supervisor_account</i></a></li>
                <li><a href="">VIEW USERS<i class="material-icons right blue-text">person_pin</i></a></li>
