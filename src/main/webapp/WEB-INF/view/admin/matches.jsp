            ...
            <body>
                ...
                <main class="valign-wrapper grey lighten-3">
                    <div class="container valign" style="margin-top: 20px;">
                                            ...
                                            <table class="centered responsive-table col s6 offset-s3">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <fmt:formatDate type="both" dateStyle="short" timeStyle="short" value="${game.date}" />
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="col s6 offset-s3">
                                                <div class="row">
                                                    <div class="input-field col s6">
                                                        <input id="g_${game.id}_t_${game.firstTeam.id}" type="number" disabled value="0">
                                                    ...
                                                    <div class="input-field col s6">
                                                        <input id="g_${game.id}_t_${game.secondTeam.id}" type="number" disabled value="0">
                                                        <!-- Id must be not just a name of team because one team may have several active games at different dates -->
                                                    ...
                                                    <c:if test="${game.status=='ACTIVE'}">
                                                        <div id="chip_${game.id}_${game.firstTeam.id}" class="chips chips-placeholder col s6">
                                                        </div>
                                                        <div id="chip_${game.id}_${game.secondTeam.id}" class="chips chips-placeholder col s6"></div>
                                                    </c:if>
                        ...
                        <br> <a class="waves-effect waves-light modal-trigger btn right green" href="#new-match-modal"><i class="material-icons right">playlist_add</i>New
        Match</a>
                        <br>
                            ...
                            <form class="col s12">
                                <div class="row">
                                    ...
                                    <div class="col s12 center-align">
                                        ...
                                        <br>
                                        <br> <span class="center-align red-text" id="messageRegistration"></span>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <script>
                    $(function () {
                        $('#chip_2_2 input.autocomplete').autocomplete({
                            data: {
                                "Andrew Bright": null,
                                "Jim Carey": null,
                                "Adam Beast": null,
                        ...
                        $('#chip_2_3 input.autocomplete').autocomplete({
                            data: {
                                "Kurwa B": null,
                                "Geogre Bush Carey": null,
                                "Mack Duck": null,
                                "Diddy Elson": null,
                                "Bald From Brazzers": null
                            }
