                        ...
                        <c:forEach var="team" items="${teams}">
                            ...
                            value="${team.name}"></c:out></strong></span></div>
                                <div class="collapsible-body center-align">
                                    ...
                                    <a class="waves-effect waves-light btn modal-trigger green darken-1" href="#add-player-modal" target="_self" id="addPlayer_team_${team.id}"><i class="material-icons right">person_add</i>Add
                            Player</a>
                                    <br>
                                    <br>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div id="new-player-form" class="col s12">
                            ...
                            <div class="col s12 center-align">
                                <button class="btn waves-effect waves-light" id="addNewPlayer">Add Player
