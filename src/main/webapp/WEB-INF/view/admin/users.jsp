                            ...
                            <ul class="tabs transparent">
                                <c:choose>
                                    ...
                                    <c:when test="${type == 'CLIENT'}">
                                        ...
                                        <li class="tab col s4 l2"><a href="users?type=BOOKMAKER&page=1" target="_self">BOOKMAKERS</a></li>
                                    </c:when>
                            ...
                            <li id="u_${user.id}">
                                ...
                                <div class="collapsible-body center-align">
                                    ...
                                    <a class="waves-effect waves-light modal-trigger btn green" href="#modal-stats">
                                        <div class="button1" id="${user.id}/${user.role}"><i class="material-icons right">timeline</i>Statistics</div>></a>
                                    <br>
                                    <br>
                                </div>
                            </li>
