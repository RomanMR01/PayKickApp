                ...
                <li id="li_${game.id}">
                    ...
                    <div class="collapsible-body center-align">
                        <div class="row">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <c:forEach var="i" begin="0" end="5">
                                                    <td>
                                                        <div class="input-field col s12">
                                                            <input id="coef_${i}_${game.id}" type="number" min="1.01"
                                                                   max="100"
                                                                   step="0.01" form="form_${game.id}"
                                                                   name="resultCoefficients" required/> <label
                                                                for="coef_${i}_${game.id}"><fmt:message
                                                                key="coefficients.name"/></label>
                                                        </div>
                                                    </td>
                                                </c:forEach>
                            ...
                            <div class="col s12 center-align">
                                ...
                                <table
                                    ...
                                    <thead>
                                    <tr>
                                        <th><c:out value="${game.firstTeam.name}"></c:out> <fmt:message
                                                key="common.goal"/></th>
                                        <th><fmt:message key="coefficients.start"/></th>
                                        <th><c:out value="${game.secondTeam.name}"></c:out> <fmt:message
                                                key="common.goal"/></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        <c:choose>
                                            <c:when test="${game.status=='ACTIVE'}">
                                                <td>
                                                    <div class="input-field col s12">
                                                        <input id="coef_start_${game.scoreCoefficient.id}" type="number"
                                                               step="0.01" min="1.01" max="100"
                                                               form="form_${game.id}" name="goalsCoefficients"
                                                               value="${game.scoreCoefficient.firstTeamCoefficient}" required/>
                                                        <label
                                                                for="coef_start_${game.scoreCoefficient.id}"><fmt:message
                                                                key="coefficients.name"/></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-field col s12">
                                                        <input id="coef_t1_${game.scoreCoefficient.id}" type="number"
                                                               step="0.01" min="1.01" max="100"
                                                               form="form_${game.id}" name="goalsCoefficients"
                                                               value="${game.scoreCoefficient.startCoefficient}" required/> <label
                                                            for="coef_t1_${game.scoreCoefficient.id}"><fmt:message
                                                            key="coefficients.name"/></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-field col s12">
                                                        <input id="coef_t2_${game.scoreCoefficient.id}" type="number"
                                                               step="0.01" min="1.01" max="100"
                                                               form="form_${game.id}" name="goalsCoefficients"
                                                               value="${game.scoreCoefficient.secondTeamCoefficient}" required/>
                                                        <label
                                                                for="coef_t2_${game.scoreCoefficient.id}"><fmt:message
                                                                key="coefficients.name"/></label>
                                                    </div>
                                                </td>
                                            </c:when>
                                            <c:otherwise>
                                                <td>
                                                    <div class="input-field col s12">
                                                        <input id="coef_start_${game.scoreCoefficient.id}" type="number"
                                                               step="0.01" min="1.01" max="100"
                                                               form="form_${game.id}" name="goalsCoefficients" required/>
                                                        <label for="coef_start_${game.scoreCoefficient.id}"><fmt:message
                                                                key="coefficients.name"/></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-field col s12">
                                                        <input id="coef_t1_${game.scoreCoefficient.id}" type="number"
                                                               step="0.01" min="1.01" max="100"
                                                               form="form_${game.id}" name="goalsCoefficients" required/> <label
                                                            for="coef_t1_${game.scoreCoefficient.id}"><fmt:message
                                                            key="coefficients.name"/></label>
                                                    </div>
                                                </td>
                                        ...
                                        <c:choose>
                                            <c:when test="${game.status=='NEW'}">
                                                <c:forEach var="player" items="${game.firstTeam.players}">
                                                    <div class="input-field col s12">
                                                        <input type="hidden" name="firstTeamPlayerId"
                                                               value="${player.id}" form="form_${game.id}" required/>
                                                        <input id="player${player.id}" type="number" step="0.01"
                                                               min="1.01" max="100"
                                                               value="5.00" form="form_${game.id}"
                                                               name="firstTeamPlayerCoefficients" required/> <label
                                        ...
                                        <c:choose>
                                            <c:when test="${game.status=='NEW'}">
                                                <c:forEach var="player" items="${game.secondTeam.players}">
                                                    <div class="input-field col s12">
                                                        <input type="hidden" name="secondTeamPlayerId"
                                                               value="${player.id}" form="form_${game.id}" required/>
                                                        <input id="player${player.id}" type="number" step="0.01"
                                                               min="1.01" max="100"
                                                               value="5.00" form="form_${game.id}"
                                                               name="secondTeamPlayerCoefficients"required/> <label
                                                            for="player${player.id}"><c:out
                                                            value="${player.fulName}"></c:out></label>
                                                    </div>
                                                </c:forEach>
                        ...
                        <button class="waves-effect waves-light btn green" type="submit" form="form_${game.id}"><i
                                class="material-icons right">done</i><fmt:message key="common.confirm"/></button>
                        <br> <br>
                    </div>
                </li>
            </c:forEach>
