        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <header>
                ...
                <ul id="balanceDropdown" class="dropdown-content grey darken-3">
                    <li><a href="" class="white-text"><fmt:message key="balance.credit" /></a></li>
                    <li><a href="" class="white-text"><fmt:message key="balance.withdraw" /></a></li>
                </ul>
                ...
                <nav>
                    <div class="nav-wrapper grey darken-3">
                        ...
                        <ul class="right hide-on-med-and-down">
                            ...
                            <li><a class="dropdown-button" data-activates="balanceDropdown"><fmt:message key="caption.balance" />: <fmt:formatNumber type="number" maxFractionDigits="2" minFractionDigits="2" value="${balance}" /><i class="material-icons right green-text">attach_money</i></a></li>
